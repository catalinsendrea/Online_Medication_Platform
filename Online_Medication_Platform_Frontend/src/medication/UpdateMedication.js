...
class UpdateMedication extends Component {
    constructor(props){
        ...
        this.updateMedicationButton = this.updateMedicationButton.bind(this);
    ...
    componentDidMount(){
        MedicationService.getMedicationById(this.state.id).then( (res) => {
            ...
            this.setState({name: medication.name,
                        list_of_side_effects: medication.list_of_side_effects,
    ...
    updateMedicationButton = (x) => {
        x.preventDefault();
        let medication = {name: this.state.name, list_of_side_effects: this.state.list_of_side_effects, dosage: this.state.dosage};
        console.log('medication  => ' +JSON.stringify(medication));

        MedicationService.updateMedication(medication, this.state.id).then(res => {
            this.props.history.push('/doctor');
        });
    }
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3"> 
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.updateMedicationButton}>Save</button>
