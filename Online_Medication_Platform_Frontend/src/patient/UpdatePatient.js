...
class UpdatePatient extends Component {
    constructor(props){
        ...
        this.updatePatientButton = this.updatePatientButton.bind(this);
    ...
    updatePatientButton = (x) => {
        x.preventDefault();
        let patient = {name: this.state.name, birth_date: this.state.birth_date, gender: this.state.gender, address: this.state.address, medical_record: this.state.medical_record, caregiver_id: this.state.caregiver_id, username: this.state.username, password: this.state.password};
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3"> 
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.updatePatientButton}>Save</button>
