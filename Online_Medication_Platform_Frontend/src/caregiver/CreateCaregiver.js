...
class CreateCaregiver extends Component {
    constructor(props){
        super(props)
        ...
        this.saveCaregiverButton = this.saveCaregiverButton.bind(this);
    ...
    saveCaregiverButton = (x) => {
        ...
        CaregiverService.createCaregiver(caregiver).then(res => {
            this.props.history.push('/doctor');
        });
    }
                ...
                <div className = "container">
                        <div className = "row">
                            <div className = "card col-md-6 offset-md-3 offset-md-3"> 
                                <h1 className="text-center">Insert Caregiver</h1>
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.saveCaregiverButton}>Save</button>
